...
void MonodzukuriKinovaDemo_Initial::configure(
...
void MonodzukuriKinovaDemo_Initial::teardown(
    mc_control::fsm::Controller &ctl_) {
  auto &ctl = static_cast<MonodzukuriKinovaDemo &>(ctl_);
}

EXPORT_SINGLE_STATE("MonodzukuriKinovaDemo_Initial",
                    MonodzukuriKinovaDemo_Initial)
